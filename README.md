...
4. Create a new **branch** and name it as `feat/community/seunomedeusuario`: `git checkout -b feat/community/yourusername`;  git checkout -d
    > Example: `git checkout -b feat/community/elidianaandrade` git checkout -d
