...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -c feat/community/seunomedeusuario`;
    > Exemplo: `git checkout -c feat/community/elidianaandrade`
